...
import SweptSurface from "../../Geometry/Surfaces/SweptSurface"
import PlaneEquation from "../../Geometry/PlaneEquation"

export default class DrawSweptSurfaceCommand extends Command
{
    scene: THREE.Scene
    surface: SweptSurface

    constructor(sectionCurve:NURBSCurveBase, pathCurve:NURBSCurveBase, scene:THREE.Scene) 
    {
        super()
        this.scene = scene
        this.surface = new SweptSurface(sectionCurve, pathCurve)
    }
